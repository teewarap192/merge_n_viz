...
Place the Python script (merge_n_viz.py) in your working folder.
Place your New Data File (e.g., file1.xlsx) in the same folder.
Place your Master Database File (e.g., file2.xlsx) in the same folder.
